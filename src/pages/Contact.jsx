    ...
    <div className="min-h-screen bg-[#d9d9d9] flex flex-col items-center py-10 px-4 font-montserrat">
      ...
      <div className="mt-10 w-full max-w-2xl flex flex-col gap-6">
        ...
        <input
          ...
          className="bg-transparent border-b-4 border-l-4 border-black px-4 py-4 font-bold text-[14px] tracking-[0.04em] outline-none"
        />
        ...
        <input
          ...
          className="bg-transparent border-b-4 border-l-4 border-black px-4 py-6 font-bold text-[14px] tracking-[0.04em] outline-none"
        />

        {/* SUBMIT BUTTON */}
      </div>
        <button className="mt-6 border-l-4 h-[45px] border-r-4 border-black px-5 py-1 font-bold text-[16px] leading-[100%] tracking-[0.1em] flex items-center justify-center">
          SUBMIT
        </button>
    </div>
  );
